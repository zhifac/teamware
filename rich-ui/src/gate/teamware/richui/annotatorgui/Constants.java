...
public interface Constants {
	public static final String APP_TITLE = "Annotator GUI";
	...
	public static final String ENABLE_ONTOLOGY_EDITOR_PARAMETER_NAME = "enable-oe";
	
	public static final String ENABLE_APPLICATION_LOG_PARAMETER_NAME = "enable-application-log";
	
	public static final String CLASSES_TO_HIDE_PARAMETER_NAME = "classes-to-hide";
	
	public static final String CLASSES_TO_SHOW_PARAMETER_NAME = "classes-to-show";
	...
	public static final String DOCSERVICE_PROXY_FACTORY_PARAMETER_NAME = "docservice-proxy-factory";
	...
	public static final String DEFAULT_CONTEXT = "/annotator-gui";

	public static final String ANNOTATOR_GUI_DIALOG_TITLE = APP_TITLE
			+ " Status:";
