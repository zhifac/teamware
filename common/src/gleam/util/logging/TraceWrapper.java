...
public class TraceWrapper implements InvocationHandler {
  ...
  public static <T> T getTraceWrapper(T realObject, Class<T> interfaceType, boolean logParams, boolean logExceptions) {
    // Send messages to the logger belonging to the real object
  ...
  public Object invoke(Object proxy, Method method, Object[] args)
          throws Throwable {
    // Don't log methods declared by java.lang.Object, i.e. equals,
    // hashCode or toString
    if(method.getDeclaringClass() == Object.class) {
      return method.invoke(realObject, args);
    }
    
    // otherwise it is an interface method, so wrap the call with
    // logging
    if(logParams) {
