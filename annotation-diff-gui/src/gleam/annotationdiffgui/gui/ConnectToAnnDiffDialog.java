...
public class ConnectToAnnDiffDialog extends ConnectDialog {
  ...
  public ConnectToAnnDiffDialog(Frame owner, boolean autoconnect) {
		...
		hookupEvents();
		if (autoconnect) {
			docserviceUrl.setText(AnnotationDiffGUI.getProperties().getProperty(
					DOCSERVICE_URL_PARAMETER_NAME));
			documentId.setText(AnnotationDiffGUI.getProperties().getProperty(
    ...
    documentIdLabel = new JLabel("Document ID");
		...
		if (AnnotationDiffGUI.getConnection() != null
				&& AnnotationDiffGUI.getConnection() instanceof DocserviceConnection) {
			docserviceUrl.setText(((DocserviceConnection) AnnotationDiffGUI
					.getConnection()).getDocserviceUrlString());
			documentId.setText(((DocserviceConnection) AnnotationDiffGUI
	...
	protected void connect() {
		...
		connectAsync(this.docserviceUrl.getText().trim(),
					 this.documentId.getText().trim());
	}
			...
			public void run() {
				...
				try {
					try {
						...
						handleError(new AnnotationDiffGUIException(
