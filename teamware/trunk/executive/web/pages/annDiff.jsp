...
<content tag="heading"><fmt:message key="annDiff.heading"/> on the document <c:out value="${param.documentName}"/></content><br>
<meta name="menu" content="ResourceMenu"/>
</head>
<fmt:message key="annDiff.message"/>
<html:form action="annDiff" styleId="annotationDifferResultForm" onsubmit="return validateAnnotationDifferResultForm(this);">
...
<table>
	...
	<td colspan="2">
	   ...
	   <input type="button" class="button" onclick="location.href='<c:url value="/documentsInCorpus.html?corpusID=${param.corpusID}&method=search"/>'"
...
<display:table name="annoDifferList" cellspacing="0" cellpadding="0"
    id="annoDifferList" pagesize="100" class="table annoDifferResultList" export="true" requestURI="">   
