...
CREATE TABLE `annotation_service_type` (
...
CREATE TABLE `annotation_service` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `url` varchar(100) NOT NULL,
  `description` varchar(255) NOT NULL,
  `parameters` text,
  `annotation_service_type_id` bigint(20) DEFAULT NULL,
  `can_use_private_urls` char(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKF198B9A563F91E39` (`annotation_service_type_id`),
  CONSTRAINT `FKF198B9A563F91E39` FOREIGN KEY (`annotation_service_type_id`) REFERENCES `annotation_service_type` (`id`)
) ENGINE=InnoDB;
...
CREATE TABLE `service` (
  ...
  `service_enabled` char(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB;
...
CREATE TABLE `project` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKED904B19C0311FC7` (`user_id`),
  CONSTRAINT `FKED904B19C0311FC7` FOREIGN KEY (`user_id`) REFERENCES `app_user` (`id`)
) ENGINE=InnoDB;
...
CREATE TABLE `user_role` (
  ...
  KEY `FK143BF46AC0311FC7` (`user_id`),
  KEY `FK143BF46A1B065BE7` (`role_id`),
  CONSTRAINT `FK143BF46A1B065BE7` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`),
  CONSTRAINT `FK143BF46AC0311FC7` FOREIGN KEY (`user_id`) REFERENCES `app_user` (`id`)
) ENGINE=InnoDB;
