...
public class ExecutiveConnection extends Connection implements Constants {
  ...
  public ExecutiveConnection(String annotatorPoolUrlString, String userId,
    String userPassword) throws AnnotatorGUIExeption {
  ...
  public AnnotatorTask getNextAnnotatorTask() throws AnnotatorGUIExeption {
    try {
  ...
  public boolean checkForNextTask() throws AnnotatorGUIExeption {
	  boolean flag = false;
	  try {
  ...
  public boolean finishTask() throws AnnotatorGUIExeption {
    if(annotatorTask == null) return false;
    return this.annotatorTask.finish();
  }

  public boolean cancelTask() throws AnnotatorGUIExeption {
    if(annotatorTask == null) return false;
