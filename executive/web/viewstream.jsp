...
{
    count++;
    ClickstreamRequest csr = (ClickstreamRequest)clickstreamIt.next();
    // assume all clicks fall under urlbase
    String click = (String)application.getAttribute("urlbase") + csr.getRequestURI();
    if(csr.getQueryString() != null && !"".equals(csr.getQueryString())) {
      click += "?" + csr.getQueryString();
    }
%>
<tr><td><%= count %>:</td><td><a href="<%= click %>"><%= click %></a></td></tr>
<%
}
%>
</table>
