...
<script type='text/javascript'>
	...
	function loadTotal(data){
      ...
      function validate(form){
	    ...
	    alert("You must select at least two annotation sets and move them to the right select box!")
          return false;
        }
      }
</script>
...
<html:form action="popupCaculateIAA" styleId="iAAResultForm" onsubmit="return validate(this);">
<script type='text/javascript'>
...
<table id="iaaTable">
	 ...
	 <tr>
        <td>
         <select name="Available" size="7" id="Available" style="width: 8em;">
        ...
        <td><select name="SelectedAS" size="7" id="SelectedAS" style="width: 8em;"></select></td>
        <td align="left">
           <script type="text/javascript">
           <!--
	...
	<td colspan="2">
	   ...
	   <input type="button" onclick="location.href='<c:url value="/documentsInCorpus.html?corpusID=${param.corpusID}&method=search"/>'"
        	value="<fmt:message key="button.cancel"/>"
       onmouseover="ajax_showTooltip('ajaxtooltip/info/iaa.jsp',this);return false" onmouseout="ajax_hideTooltip()" 	
       />
	</td>
	</tr>
</table>
