 ...
 * commonly used when constructing user interface elements which have a
 * label to be displayed to the user, and a corresponding value to be
 * returned to the server. One example is the
 * <code>&lt;html:options&gt;</code> tag. <p/> <p/> Note: this class
...
public class LabelValue implements Comparable, Serializable {
  ...
  // Methods
  /**
   * Compare LabelValueBeans based on the label, because that's the
   * human viewable part of the object.
   * 
   * @see Comparable
   */
