...
/**
 * Filter that compresses output with gzip (assuming that browser
 * supports gzip). Code from <a
 * href="http://www.onjava.com/pub/a/onjava/2003/11/19/filters.html">
 * http://www.onjava.com/pub/a/onjava/2003/11/19/filters.html</a>.
 * 
 * &copy; 2003 Jayson Falkner You may freely use the code both
...
public class GZIPFilter extends OncePerRequestFilter {
  ...
  private boolean isGZIPSupported(HttpServletRequest req) {
    ...
    // disable gzip if the request has a disableGzip parameter
    if(Boolean.valueOf(req.getParameter("disableGzip"))) {
      log.debug("gzip disabled by request");
      return false;
    }
