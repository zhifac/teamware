...
/**
 * <p>
 * This class is designed to put all the public variables in a class to
 * a specified scope - designed for exposing a Constants class to Tag
 * Libraries.
 * </p>
 * 
 * <p>
 ...
 * @version $Revision: 1.7 $ $Date: 2006-01-29 22:00:13 -0700 (Sun, 29
 *          Jan 2006) $
 * 
 * @jsp.tag name="constants" bodycontent="empty"
 *          tei-class="gleam.executive.webapp.taglib.ConstantsTei"
 */
public class ConstantsTag extends TagSupport {
    ...
    try {
      ...
      if(var == null) {
        ...
        for(int i = 0; i < fields.length; i++) {
           ...
           * scope + " scope"); }
           */
          pageContext.setAttribute(fields[i].getName(), fields[i].get(this),
                  toScope);
        }
      }
      else {
  ...
  /**
   * Maps lowercase JSP scope names to their PageContext integer
   * constant values.
   */
