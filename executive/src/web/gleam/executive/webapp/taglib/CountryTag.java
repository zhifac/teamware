...
/**
 * Tag for creating multiple &lt;select&gt; options for displaying a
 ...
 * @version $Revision: 1.4.2.1 $ $Date: 2006-06-10 08:00:48 -0600 (Sat,
 *          10 Jun 2006) $
 * 
...
public class CountryTag extends TagSupport {
   ...
   * the two letter uppercase ISO name of the country as the value and
   * the localized country name as the label.
   * 
