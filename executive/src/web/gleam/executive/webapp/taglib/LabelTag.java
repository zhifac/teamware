...
/**
 * <p>
 * This class is designed to render a <label> tag for labeling your
 * forms and adds an asterik (*) for required fields. It was originally
 * written by Erik Hatcher
...
public class LabelTag extends TagSupport {
  ...
  public int doStartTag() throws JspException {
    ...
    ValidatorResources resources = (ValidatorResources)pageContext
            .getServletContext().getAttribute(ValidatorPlugIn.VALIDATOR_KEY);
    ...
    if(errors != null) {
      ...
      while(valIterator.hasNext()) {
        ...
        valMessage.append(tagUtils.message(pageContext, Globals.MESSAGES_KEY,
                locale.getDisplayName(), error.getKey(), error.getValues()));
      }
    }

    // Retrieve the message string we are looking for
    String message = tagUtils.message(pageContext, Globals.MESSAGES_KEY, locale
            .getDisplayName(), key);
    ...
    if((message == null) || "".equals(message.trim())) {
      ...
      if(valError.length() > 0) {
        ...
        label.append(tagUtils.message(pageContext, Globals.MESSAGES_KEY, locale
                .getDisplayName(), "icon.warning"));
        label.append("\" ");
        ...
        label.append(tagUtils.message(pageContext, Globals.MESSAGES_KEY, locale
                .getDisplayName(), "icon.warning.img"));
        label.append("\" />");
      }
    }
