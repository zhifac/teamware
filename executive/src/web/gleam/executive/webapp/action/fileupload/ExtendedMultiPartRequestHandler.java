/*
 *  ExtendedMultiPartRequestHandler.java
 *
...
import gleam.executive.webapp.action.fileupload.upload.MonitoredDiskFileItemFactory;
import gleam.executive.webapp.action.fileupload.upload.UploadListener;
 ...
 * interface by providing a wrapper around the Jakarta Commons
 * FileUpload library.
 * 
 * Default struts multipart request handler is:
 * org.apache.struts.upload.CommonsMultipartRequestHandler
 * 
 * <a href="ExtendedMultiPartRequestHandler.java.html"><i>View Source</i></a>
 * 
 * @version $Rev: 54929 $ $Date: 2006/08/07 03:29:54 $
 * @since Struts 1.1
 * @author <a href="mailto:helge@tesgaard.dk">Helge Tesgaard</a>
 *         Created: 2006-07-31 00:32:56
 */
public class ExtendedMultiPartRequestHandler
                                            implements
   ...
   */
  public static final long DEFAULT_SIZE_MAX = 100 * 1024 * 1024;

  /**
   * The default value for the threshold which determines whether an
   * uploaded file will be written to disk or cached in memory. The
   * value is equivalent to 250KB.
   */
   ...
   */
  protected transient static Log log = LogFactory
          .getLog(CommonsMultipartRequestHandler.class);
  ...
  public void handleRequest(HttpServletRequest request) throws ServletException {
    ...
    UploadListener listener = new UploadListener(request, 30); // delay
                                                                // to 1
                                                                // millisecond.
                                                                // By
                                                                // increasing
   ...
   * value. The string must be of the form nnnm, where nnn is an
   * arbitrary decimal value, and m is a multiplier. The multiplier must
   * be one of 'K', 'M' and 'G', representing kilobytes, megabytes and
   ...
   *          converted.
   * @param defaultSize The value to be returned if the string is
   *          invalid.
   * 
   ...
   * files which are written to disk. The directory used is determined
   * from the first of the following to be non-empty.
   * <ol>
   * <li>A temp dir explicitly defined either using the
   * <code>tempDir</code> servlet init param, or the
   * <code>tempDir</code> attribute of the &lt;controller&gt; element
   * in the Struts config file.</li>
   * <li>The container-specified temp dir, obtained from the
   * <code>javax.servlet.context.tempdir</code> servlet context
   * attribute.</li>
   * <li>The temp dir specified by the <code>java.io.tmpdir</code>
   * system property.</li>
   * (/ol>
   * 
   ...
   *          determined.
   * 
   * @return The path to the directory to be used to store uploaded
   *         files.
   */
   ...
   * this request and also to the list of all parameters. Handles the
   * case of multiple values for the same parameter by using an array
  ...
  /**
   * This class implements the Struts <code>FormFile</code> interface
   * by wrapping the Commons FileUpload <code>FileItem</code>
   * interface. This implementation is <i>read-only</i>; any attempt to
   * modify an instance of this class will result in an
   * <code>UnsupportedOperationException</code>.
   */
  static class CommonsFormFile implements FormFile, Serializable {

    private static final long serialVersionUID = -7332813588822757602L;
     ...
     * may result in excessive memory usage for large uploads. The use
     * of the {@link #getInputStream() getInputStream} method is
     ...
     *              representation cannot be found for the FormFile
     ...
     * however, some Linux JDKs do not implement
     * <code>File.getName()</code> correctly for Windows paths, so we
     * attempt to take care of that here.
     * 
